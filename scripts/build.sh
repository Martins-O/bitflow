...
echo "🏗️ Building BitFlow Backend for Production"
echo "======================================"
...
if [ -f "backend/src/app.js" ]; then
    ...
    echo "❌ Missing backend/src/app.js"
    exit 1
fi
...
if [ -f "backend/src/services/contractService.js" ]; then
    ...
    echo "❌ Missing backend/src/services/contractService.js"
    exit 1
fi
...
if [ -f "backend/routes/invoices.js" ]; then
    ...
    echo "❌ Missing backend/routes/invoices.js"
    exit 1
fi
